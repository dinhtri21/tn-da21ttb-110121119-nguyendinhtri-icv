  ...
  return (
    <>
      ...
      <div className="group relative cv-block-container">
        ...
        <div className="cv-block-controls absolute top-[0px] left-[-30px] opacity-0 group-hover:opacity-100 transition-opacity duration-200 print:hidden flex flex-col gap-2 p-[4px] bg-gray-100 backdrop-blur-sm rounded-t">
          <ActionIcon
            size="sm"
            variant="light"
            {...attributes}
