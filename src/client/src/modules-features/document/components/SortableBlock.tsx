  ...
  return (
    <>
      ...
      <div className="group relative cv-block-container">
        ...
        <div className="cv-block-controls absolute top-[-20px] left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 print:hidden flex gap-2 p-2 bg-gray-100 backdrop-blur-sm rounded-tr">
          <button
