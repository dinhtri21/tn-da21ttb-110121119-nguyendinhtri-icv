...
export default function IConicTemplate() {
  return (
    <>
      <Box
        // miw={"1131.0136220472px"}
        style={{
          transform: "scale(0.77)",
          transformOrigin: "top left", // hoặc "center center"
        }}
      >
        <Paper
          shadow="xl"
              ...
              <Flex direction="column" justify="center" mt={15}>
                ...
                <Grid mt={8} pl={6}>
                  ...
                  <Grid.Col span={8} py={0}>
                    ...
                    <Text size="md" fs="italic">
                      Using a Low-Code platform, connecting communities,
                      providing quick information, managing humanitarian aid.
                    </Text>
